...
from ..models import AnnotationOpen
from ..serializers.AnnotationOpenSerializer import AnnotationOpenSerializer

class AnnotationOpenAPI(generics.CreateAPIView):
    queryset = AnnotationOpen.objects.all()
    serializer_class = AnnotationOpenSerializer
